  ...
  return (
    <div className="w-full flex flex-col gap-6">
      <div className="flex flex-col lg:flex-row  gap-6 justify-around text-text-secondary w-full">
            <SingleCard tittle={"AI Overview Coverage Keywords"} value={geoKpis && geoKpis?.aiOverviewCoverage?.totalKeywords} loading={loading} img={ai} description={'The number of your keywords that appear in AI-generated search results (e.g., AI overviews). This value reflects the latest available data and does not change with the date filter!'}/>
            ...
            <SingleCard tittle={"AI Citations"} value={seoMetricsFromDb?.aICitationReadiness} loading={loading} img={citation} description={'The Estimated number of times your website is referenced or cited in AI-generated search results. This value reflects the latest available data and does not change with the date filter!'}/>
            <SingleCard tittle={"GEO Visibility Share"} value={`${pageVisibilityShare.page1Share} %`} loading={loading} img={share} description={'Your share of visibility in AI-generated search results compared to competitors. This value reflects the latest available data and does not change with the date filter!'}/>
        </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 justify-around">
          ...
          <PieChart title='GEO Ranking Distribution' data={rankingDistribtuion} loading={loading} description={'Ranking Distribution Shows how your keywords are spread across search ranking positions.Top 3% of keywords in positions 1–3 (highest visibility).4–10% of keywords on page 1 (strong visibility).11–20% of keywords on page 2 (moderate visibility).21–100% of keywords beyond page 2 (low visibility, growth opportunity). This value reflects the latest available data and does not change with the date filter!'}/>
      </div>
    </div>
  )
}
