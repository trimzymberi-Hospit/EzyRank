  ...
  return (
    <div className="w-full flex flex-col gap-6">
         <div className="flex flex-col lg:flex-row  gap-6 justify-around text-text-secondary w-full">
            <SingleCard tittle={"Organic Traffic"} value={new Intl.NumberFormat('de-CH').format(seoMetricsFromDb?.organicTraffic)} loading={loading} img={trafficIcon} description={'The estimated number of visitors coming to your website from unpaid search results (like Google), without ads'}/>
            ...
            <SingleCard tittle={"Switzerland Traffic"} value={new Intl.NumberFormat('de-CH').format(chTrafficOrganic?.organicTraffic)} loading={loading} img={switzerland} description={'The estimated number of visitors coming to your website from Switzerland through organic (unpaid) search results'}/>
            <SingleCard tittle={"Authority Score"} value={chTrafficOrganic?.authorityScore} loading={loading} img={score} description={'A metric that indicates how strong and trustworthy your website is, based on factors like backlinks and overall SEO performance. Higher scores suggest better ability to rank'}/>
            <SingleCard tittle={"Backlinks Total"} value={new Intl.NumberFormat('de-CH').format(chTrafficOrganic?.totalBacklinks)} loading={loading} img={links} description={'The total number of links from other websites that point to your site. These links help search engines evaluate your sites credibility and popularity'}/>
            <SingleCard tittle={"Organic Keywords"} value={new Intl.NumberFormat('de-CH').format(chTrafficOrganic?.organicKeywords)} loading={loading} img={keywords} description={'The number of search terms (keywords) for which your website appears in search engine results'}/>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 w-full justify-around">
            ...
            description={`Ranking Distribution Shows how your keywords are spread across search ranking positions.Top 3% of keywords in positions 1–3 (highest visibility).4–10% of keywords on page 1 (strong visibility).11–20% of keywords on page 2 (moderate visibility).21–100% of keywords beyond page 2 (low visibility, growth opportunity).`}/>
            ...
            <TopKeywordsVolume data={topKeywords} tittle="Top Keywords" description={'Shows your highest-ranking keywords and their current positions in search results.'}/>
        </div>
        <div className="flex flex-col lg:flex-row gap-6 w-full justify-around">
            ...
            <LegendAreaChart weeks={seoMetricsFromDb?.backLinksLast6Months?.weeks} titleLabel='New vs Lost backlinks (weekly)' description={'New and Lost Backlinks total number between 6 days for Last 6 Months'}/>
        </div>
        <div className="flex flex-col lg:flex-row gap-6 w-full justify-around">
