  ...
  return (
    <div className="w-full flex flex-col gap-6">
        <div className="flex flex-col lg:flex-row  gap-6 justify-around text-text-secondary w-full">
            ...
            <SingleCard tittle={"Lead Clicks"} value={topViewedPages.length > 0 && topViewedPages.find(c => c?.pagePath?.includes("contact") || c?.pagePath?.includes("kontact")).views || 0} loading={loading} img={lead}/>
